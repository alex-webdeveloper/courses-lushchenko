...
function submitForm(event) {
    ...
    form[1].value = '';
    form[3].value = '';
    let out = document.querySelector('p.out');
    out.innerHTML = 'Переданно!';
        // setTimeout(() => out.innerHTML = '', 10000);
}

document.querySelectorAll('.inp').forEach(item => item.oninput = () => document.querySelector('p.out').innerHTML = '');
