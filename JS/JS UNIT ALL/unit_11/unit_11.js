...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = d11.indexOf(v);
}
...
function f14() {
    d14 = [];
    let v = +document.querySelector('.i-14').value;
    for (i = 1; i <= v; i++) {
        d14.push(1);
    }
...
function f15() {
    let v = +document.querySelector('.i-15').value;
    if (d15.indexOf(v) === - 1) {
        d15.push(v);
    }
...
function f18() {
    let v = document.querySelector('.i-18').value;
    document.querySelector('.out-18').innerHTML = d18.includes(v);
