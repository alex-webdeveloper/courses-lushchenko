...
// при сложении строки и числа всегда получаем строку, а при сложение чисел получаем число
...
function t10() {
    ...
    //out10.innerHTML = +i10.value * 10;// можно делать вывод через innerHTML результат тот-же
}
...
function t13() {
    out13.textContent = +i13_1.value + +i13_2.value;
}
...
function t16() {
    out16.textContent = +i16_1.value + +i16_2.value;
}
...
function t19() {
    let t = document.querySelector('.i-19-1').value;
    t = parseInt(t);
    let f = document.querySelector('.i-19-2').value;
    f = parseInt(f);
    document.querySelector('.out-19').textContent = t + f;
}
...
function t20() {
    document.querySelector('.out-20').textContent = 'Уважаемый ' + i20_1.value + ', ' + i20_2.value + ', ' + 'ваш возраст ' + i20_3.value + 'года' + ', ' + 'по професси вы ' + i20_4.value;
}
