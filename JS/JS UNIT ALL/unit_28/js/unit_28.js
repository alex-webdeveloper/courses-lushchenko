...
let goods2 = new Goods('Pumpkin', 10, 'img/2.png', 12);
...
let goods3 = new Goods2('Pumpkin', 5, 'img/2.png', 12, true);
...
let valid = new Valid('example@yandex.ru', 'trsaw');
valid.validate();
...
let valid9 = new Valid('Alex', 'ggqwenm');
valid9.validate();
...
let valid2 = new Valid2('', 'iufgersdw');
valid2.validate();
console.log(valid2);
...
let valid3 = new Valid2('email.google.com', 'uytcvderqw');
valid3.validate();
console.log(valid3);