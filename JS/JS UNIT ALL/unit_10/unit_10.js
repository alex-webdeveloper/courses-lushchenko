...
let ar1 = [3, 5, 'array', true, 78, 'string', false];
...
let ar2 = [38, 24, 'go', true, false, 99, 'inner', 8];
...
let ar3 = [3, 5, 'path', 78, 'string', 987, 'dest'];
...
// let ar5 =
let ar5 = [1, 7, 35, 4, 8, 2, 43, 1, 9, 11];
