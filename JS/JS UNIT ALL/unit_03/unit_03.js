...
function f10() {
    ...
    document.querySelector('.out-10').innerHTML = v;
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = v;
}
...
// так как в let v мы получили value без плюса это будет строка а в данном случае: let v = +i130.value; мы получим number при вводе в input чисел
...
function f15() {
    ...
    if (v == '&&') out.innerHTML = a && b; // выберет второе значение
    else out.innerHTML = a || b; // выберет первое значение
