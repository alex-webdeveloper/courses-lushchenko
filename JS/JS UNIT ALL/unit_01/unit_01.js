...
document.querySelector(".three").innerHTML = "<h3>The add h3</h3>";
...
document.querySelector(".four").innerHTML = "<h4>The add h4</h4>";
document.querySelector(".four").innerHTML += "<p>это параграф</p>";
