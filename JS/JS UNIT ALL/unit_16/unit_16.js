...
function f3() {
    let divN = document.getElementsByClassName('out-3');
    for (let i = 0; i < divN.length; i++) {
        divN[i].textContent = 3;
    }
}
...
function f4() {
    let divQ = document.querySelectorAll('.out-4');
    for (let i = 0; i < divQ.length; i++) {
        divQ[i].textContent += 4;
    }
}
...
function f15() {
    let divQ = document.querySelectorAll('.out-15');
    for (let item of divQ) {
        item.textContent = 15;
    }
