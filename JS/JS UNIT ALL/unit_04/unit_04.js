...
function f5() {
    ...
    if (myCheckBox.checked) {
        document.querySelector('.out-5').innerHTML = myCheckBox.value;
    }
    else {
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = v;
}
...
function f8() {
    ...
    document.querySelector('.out-8').innerHTML += '<button class="b-81"></button>';
    document.querySelector(".b-81").onclick = f81;

}

function f81() {
    let v = document.querySelector(".i-81").value;
    document.querySelector('.out-81').innerHTML = v;
}
