    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3 bg-secondary">
                <aside>
                    <h4 class="text-center mt-3">Welcome admin</h4>
                    <nav class="nav flex-column align-items-center mb-3">
                        <a class="nav-link" href="http://localhost:8888/project_php_mamp/admin">MAIN</a>
                        <a class="nav-link" href="http://localhost:8888/project_php_mamp/admin/create">CREATE</a>
                        <a class="nav-link" href="http://localhost:8888/project_php_mamp/logout">LOGOUT</a>
                    </nav>
                </aside>
            </div>