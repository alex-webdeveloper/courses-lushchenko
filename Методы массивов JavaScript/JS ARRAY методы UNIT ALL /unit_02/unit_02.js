...
const f1 = () => {
    let n = +document.querySelector('.i-1').value;
    document.querySelector('.out-1').textContent = a1.includes(n);
}
...
const f2 = () => {
    let n = +document.querySelector('.i-2').value;
    let out = document.querySelector('.out-2');
    if (a2.includes(n)) out.textContent = a2.indexOf(n);
...
const f3 = () => {
    let out = false;
    let n = +document.querySelector('.i-3').value;
    for (let item of a3) {
        if (item.includes(n)) out = true;
        break;
    }
...
const f4 = () => {
    let out = '';
    let n = +document.querySelector('.i-4').value;
    for (let key in a4) {
        if (a4[key].includes(n)) out += key + ' ';
    }
...
const f5 = () => {
    let n = +document.querySelector('.i-5-1').value;
    let i = document.querySelector('.i-5-2').value;
    document.querySelector('.out-5').textContent = a5.includes(n, i);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').textContent = a6.includes(str);
}
...
const f8 = () => {
    ...
    document.querySelector('.out-8').textContent = a8.includes(v);
}
...
let a9 = ['A', 'b', 'c', 'C', 'D', 12, 5, 'd', 1, '2'];

const f9 = () => {
    let v = document.querySelector('.i-9').value;
    // if (typeof v == 'string') {
    v = v.toLocaleLowerCase();
    a9 = a9.toString().toLocaleLowerCase();
    console.log(a9);
    // }
    document.querySelector('.out-9').textContent = a9.includes(v);
    console.log('09');
}
