...
const f12 = () => {
    let res = a12.reduce((accum, item, index, arr) => {
        console.log(arr, ' :arr');
        console.log(arr[accum], ' :arr[accum]');
...
let a14 = [[4, 4, 4, 8, 8], [4, 4], [4, 4, 4, 4], [4], [4, 4]];
...
// нашел в инете еще довольно интересный способ решения этой задачи:
// let reversed = a20.reduce((accum, item) => {
//     return [item, ...accum];
// }, []);
