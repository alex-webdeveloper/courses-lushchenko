...
const f1 = () => {
    ...
    document.querySelector('.out-1').textContent = a1.indexOf(n);
}
...
const f2 = () => {
    ...
    if (a2.indexOf(n) !== -1) out.textContent = a2.indexOf(n);
...
const f3 = () => {
    ...
    if (a3.indexOf(n) !== -1) out.textContent = true;
    else out.textContent = false;
}
...
const f5 = () => {
    ...
    document.querySelector('.out-5').textContent = a5.indexOf(n, i);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').textContent = a6.indexOf(v);
}
...
const f8 = () => {
    res08 = [];
    let n = +document.querySelector('.i-8').value;
    let index = a8.indexOf(n);
    while (index !== -1) {
        res08.push(index);
        index = a8.indexOf(n, index + 1);
    }
...
const f9 = () => {
    let out = '';
    let n = +document.querySelector('.i-9').value;
