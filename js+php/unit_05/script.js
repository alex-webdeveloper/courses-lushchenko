...
document.querySelector('h1').outerHTML = '<h2>H1 outerHTML</h2>';
document.querySelector('h2').outerText = '<h2>H2 outerText</h2>';
// ----------------------

document.querySelector('div').insertAdjacentHTML('beforebegin', 2222 + 'beforebegin');
document.querySelector('div').insertAdjacentHTML('afterbegin', 333 + 'afterbegin');
document.querySelector('div').insertAdjacentHTML('afterend', 5555 + 'afterend');
document.querySelector('div').insertAdjacentHTML('beforeend', 4444 + 'beforeend');
